...
public interface ChatMessageService {
     ...
     */
    @Deprecated
    void handlePrivateMessage(com.cgs.smartclass.model.websocket.WebSocketMessage message);
     ...
     */
    @Deprecated
    void handleFriendRequest(com.cgs.smartclass.model.websocket.WebSocketMessage message);
     ...
     */
    @Deprecated
    void handleSystemNotification(com.cgs.smartclass.model.websocket.WebSocketMessage message);
