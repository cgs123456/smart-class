...
import com.cgs.smartclass.model.dto.user.*;
...
public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
    ...
    String captchaUuid = userLoginRequest.getCaptchaUuid();
    String captchaCode = userLoginRequest.getCaptchaCode();
    if (StringUtils.isAnyBlank(userAccount, userPassword)) {
        throw new BusinessException(ErrorCode.PARAMS_ERROR);
    }
    LoginUserVO loginUserVO = userService.userLogin(userAccount, userPassword, captchaUuid, captchaCode, request);
...
public BaseResponse<LoginUserVO> userLoginByPhone(@RequestBody UserLoginByPhoneRequest userLoginByPhoneRequest, HttpServletRequest request) {
    ...
    String captchaUuid = userLoginByPhoneRequest.getCaptchaUuid();
    String captchaCode = userLoginByPhoneRequest.getCaptchaCode();
    if (StringUtils.isAnyBlank(userPhone, userPassword)) {
        throw new BusinessException(ErrorCode.PARAMS_ERROR);
    }
    LoginUserVO loginUserVO = userService.userLoginByPhone(userPhone, userPassword, captchaUuid, captchaCode, request);
    return ResultUtils.success(loginUserVO);
}
...
public BaseResponse<LoginUserVO> userLoginByWxOpen(HttpServletRequest request,
    ...
    return ResultUtils.success(userService.userLoginByWxOpen(code, request));
}
